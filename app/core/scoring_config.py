...
class ScoringConfig:
    ...
    # Rating = 100 × Conf(N) × [ 0.30·W_score + 0.15·ROI_score + 0.50·PnL_score + 0.05·(1 - Risk_Score) ]
    weight_win_rate: float = 0.30       # wW - Win Rate weight (30%)
    weight_roi: float = 0.15            # wR - ROI weight (15%)
