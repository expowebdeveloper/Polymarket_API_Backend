...
def calculate_user_tag(total_pnl: float, total_predictions: int) -> Optional[Dict[str, str]]:
    ...
    if total_pnl >= 100:  # 100 <= PnL < 1000
        return {
            ...
            "emoji": "🚀✨",
            "style": "bg-purple-500/10 text-purple-300 border-purple-500/50 shadow-[0_0_20px_rgba(168,85,247,0.4)]"
        }
    if total_pnl >= 20:  # 20 <= PnL < 100
        return {
            "title": "Green Beginning",
            "emoji": "🟢🌱",
            "style": "bg-emerald-500/10 text-emerald-300 border-emerald-500/50 shadow-[0_0_20px_rgba(16,185,129,0.4)]"
        }
