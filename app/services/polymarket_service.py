...
class PolymarketService:
    ...
    async def calculate_portfolio_stats(user_address: str, time_period: str = "all") -> Dict[str, Any]:
        ...
        total_pnl = float(leaderboard_stats.get("pnl", 0.0))
        total_volume = float(leaderboard_stats.get("volume", 0.0)) # Previously "total_investment"
        ...
        max_stake = 0.0
        worst_loss = 0.0
        all_losses = []  # Collect all losses for average calculation
        ...
        return {
            ...
            "performance_metrics": {
                ...
                "wins": wins,
                "all_losses": [round(loss, 2) for loss in all_losses]
            },
            "positions_summary": {
